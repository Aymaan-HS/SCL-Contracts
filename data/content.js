...
const PROJECTS = [
  {
    id: 1, category: "facade",
    title: "DLF Cyber Hub — Facade Renovation",
    tags: ["TMS", "Facade", "SKK Paints"],
    location: "Gurugram, Haryana", year: 2023, area: "1,40,000 sq.ft", value: "₹12 Cr", status: "Completed",
  ...
  },
  {
    ...
    title: "Prestige Tech Park — Waterproofing",
    tags: ["Waterproofing", "Basement", "Podium"],
    location: "Bengaluru, Karnataka", year: 2024, area: "2,20,000 sq.ft", value: "₹8.5 Cr", status: "Completed",
  ...
  {
    id: 3, category: "design-build",
    title: "Hiranandani Hospital — Design-Build",
    tags: ["Design-Build", "Healthcare", "Turnkey"],
    location: "Mumbai, Maharashtra", year: 2022, area: "85,000 sq.ft", value: "₹34 Cr", status: "Completed",
  ...
  {
    id: 4, category: "retrofitting",
    title: "Raheja Tower — Seismic Retrofitting",
    tags: ["Retrofitting", "Seismic", "Structural"],
    location: "Hyderabad, Telangana", year: 2023, area: "18-storey tower", value: "₹6.2 Cr", status: "Completed",
  ...
  {
    id: 5, category: "flooring",
    title: "Kolkata Metro Tower — Flooring",
    tags: ["Flooring", "Marble", "Vitrified"],
    location: "Kolkata, West Bengal", year: 2024, area: "60,000 sq.ft", value: "₹4.8 Cr", status: "Ongoing",
  ...
  },
  {
    ...
    title: "ITC Royal Bengal — Roofing",
    tags: ["Roofing", "Waterproofing", "Hospitality"],
    location: "Kolkata, West Bengal", year: 2022, area: "28,000 sq.ft roof", value: "₹3.1 Cr", status: "Completed",
...
const DIRECTORS = [
  {
    name: "Charitra Maheshwari", role: "Managing Director", initials: "CM", color: "#00D4FF",
  ...
  {
    name: "Gaurav Agarwal", role: "Executive Director", initials: "GA", color: "#FF6B00",
  ...
  {
    name: "Manvendra Pratap Singh", role: "Executive Director", initials: "MP", color: "#00FFE0",
  ...
  {
    name: "Inderpal Singh", role: "Independent Director", initials: "IS", color: "#B060FF",
    bio: "Brings governance expertise and cross-industry perspective to strategic decisions, audit oversight and the company's compliance framework."
  },
  {
    name: "Asha Mittal", role: "Independent Director", initials: "AM", color: "#FF4080",
    bio: "Provides independent oversight on board committees with experience in corporate governance, risk management and stakeholder engagement."
  }
];
...
const TIMELINE = [
  { year: "2002", title: "Founded", desc: "Started in Delhi & Kanpur as a single-brand focused company with a team of 4." },
  ...
  { year: "2024", title: "SCL Contracts", desc: "SCL Contracts Pvt. Ltd. launched as dedicated construction subsidiary." }
];
