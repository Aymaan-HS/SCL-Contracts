...
`;
  ...
  if (dGrid)  DIRECTORS.slice(0, 2).forEach((d, i) => dGrid.appendChild(makeDirectorCard(d, i)));
  if (dGrid2) DIRECTORS.slice(2).forEach((d, i) => dGrid2.appendChild(makeDirectorCard(d, i + 3)));
